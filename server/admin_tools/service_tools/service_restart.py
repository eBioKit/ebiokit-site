...
#
#  This tool restarts the eBioKit services.
#
#  Version: 0.1
#
#  Changelog:
...
def show_help(message=""):
    ...
    print message
    print "Usage: service_restart [-s service_name | -a]"
    print "       where"
    print "   -a, --all     : Restart all eBioKit services"
    print "   -s, --service : Restart the selected eBioKit service "
    services = []
    for service in INSTALLED_SERVICES:
